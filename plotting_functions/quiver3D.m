function qHandle = quiver3D(posArray, magnitudeArray, arrowColors, stemRatio,radiusRatio)
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    %% ----------------------------------------------------------------------------------Default parameters     
    if nargin<5
       radiusRatio = 0.05; % radius to length ratio 
    end
    if nargin<4  
        stemRatio = 0.75; % stem to arrowhead ratio
    end
    ...
    hold on;    
    for i=1:numArrows
        qHandle(i,:) = arrow3D(posArray(i,:), magnitudeArray(i,:), arrowColors(i,:), stemRatio,radiusRatio);
    end
