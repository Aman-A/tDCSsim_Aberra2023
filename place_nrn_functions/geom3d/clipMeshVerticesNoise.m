function [cVertices, cFaces] = clipMeshVerticesNoise(vertices, faces, box)
%CLIPMESHVERTICES Clip vertices of a surfacic mesh and remove outer faces
%
%   [V2, F2] = clipMeshVerticesNoise(V, F, B)
...
[cVertices, indVertices] = boxDelete(vertices, box);
